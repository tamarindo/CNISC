...
class App(baseModel):
	...
	provedor =  models.CharField(max_length=1, choices=Provedores, verbose_name=_("Provedores"))
...
class TokenSocial(baseModel):
	...
	fecha_expiracion =  models.DateTimeField(verbose_name=_("fecha expiracion"))
	
	
	def __unicode__(self):
		return self.cuenta.nombre+" de "+" :"+self.cuenta.user
